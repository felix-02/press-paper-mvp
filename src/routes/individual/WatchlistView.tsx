...
export function WatchlistView() {
  ...
  const { lists, available, itemIds, removeItem } = useWatchlists();
  ...
  return (
    <AppShell kind="individual" maxWidth={860}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
        ...
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 700, letterSpacing: "-0.02em" }}>{list?.name ?? "Watchlist"}</h1>
